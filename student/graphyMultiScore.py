...
def graphMultiRepresent(testNames, studentScores, topperScores, name):
    ...
    plt.bar(p, topperScores, width, color="b", label="Topper")
...
#g = graphMultiRepresent(testNames, studentScores, topperScores, name)
#g.showinfo()
